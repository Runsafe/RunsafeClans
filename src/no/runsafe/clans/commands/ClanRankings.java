...
{
	public ClanRankings(IScheduler scheduler, RankingHandler rankingHandler, ClanHandler clanHandler, Config config)
	{
	...
	{
		executor.sendColouredMessage(Config.Message.Info.clanRankingsRecentLine1);
	...
	private String formatHoverText(Clan clan)
	{
		return String.format(Config.Message.Info.clanRankingsHoverText,
			clan.getRecentDergonKills(),
			clan.getRecentClanKills(),
			clan.getRecentClanDeaths(),
